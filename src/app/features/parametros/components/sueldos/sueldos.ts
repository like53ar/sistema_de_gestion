        ...
        <div class="zen-modal-container sm" (click)="$event.stopPropagation()">
            ...
            <div class="modal-content centered-content">
                <div class="construction-container">
                    ...
                    <h2>Sueldos en Desarrollo</h2>
                    <p>Estamos trabajando en los parámetros de liquidación de haberes y legajos. Próximamente en esta sección.</p>
...
export class ParametrosSueldos {
